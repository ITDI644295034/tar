...
class AiringDetailPage extends StatefulWidget {
  const AiringDetailPage({super.key});

  @override
  State<AiringDetailPage> createState() => _MovieDetailPageState();
}

class _MovieDetailPageState extends State<AiringDetailPage> {
  Result? _movieModel;
